    ...
    ComponentCode.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            React.createElement("h3", { style: { color: '#6A39D7' } },
                "<img> Code",
                ' ',
                React.createElement("a", { href: 'https://github.com/gkoberger/avataaars', style: { fontSize: '0.8em' }, target: '_blank' },
                    React.createElement("i", { className: 'fa fa-github' }),
                    " Repo")),
            React.createElement("p", null, "You can include this as an SVG <img> from the API."),
