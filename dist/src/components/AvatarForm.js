...
var OptionSelect = /** @class */ (function (_super) {
    ...
    OptionSelect.prototype.render = function () {
        ...
        return (React.createElement(FormGroup, { className: 'row', controlId: controlId },
            React.createElement(Col, { componentClass: ControlLabel, sm: 3 }, label),
            React.createElement(Col, { sm: 9 },
                React.createElement(FormControl, { componentClass: 'select', value: value, onChange: this.onChange }, children))));
    };
    return OptionSelect;
}(React.Component));
var AvatarForm = /** @class */ (function (_super) {
    ...
    AvatarForm.prototype.render = function () {
        ...
        var labelCol = 3;
        var inputCol = 9;
        return (React.createElement(Form, { horizontal: true },
            React.createElement(FormGroup, { className: 'row', controlId: 'avatar-style' },
                React.createElement(Col, { componentClass: ControlLabel, sm: 3 }, "Avatar Style"),
                React.createElement(Col, { sm: 9 },
                    React.createElement("label", null,
                        React.createElement("input", { type: 'radio', id: 'avatar-style-circle', name: 'avatar-style', value: AvatarStyle.Circle, checked: avatarStyle === AvatarStyle.Circle, onChange: this.onAvatarStyleChange }),
                        ' ',
                        "Circle"),
                    ' ',
                    React.createElement("label", null,
                        React.createElement("input", { type: 'radio', id: 'avatar-style-transparent', name: 'avatar-style', value: AvatarStyle.Transparent, checked: avatarStyle === AvatarStyle.Transparent, onChange: this.onAvatarStyleChange }),
                        ' ',
                        "Transparent"))),
            selects,
            React.createElement(FormGroup, { className: 'row' },
                React.createElement(Col, { className: "offset-sm-" + labelCol, smOffset: labelCol, sm: inputCol },
                    "More options coming soon,",
                    ' ',
                    React.createElement("a", { href: 'http://eepurl.com/c_7fN9', target: '_blank' }, "subscribe for updates"))),
            React.createElement(FormGroup, { className: 'row' },
                React.createElement(Col, { className: 'offset-sm-' + labelCol, smOffset: labelCol, sm: inputCol },
                    React.createElement(Button, { bsStyle: 'primary', type: 'submit', onClick: this.onDownloadPNG },
                        React.createElement("i", { className: 'fa fa-download' }),
                        " PNG"),
                    ' ',
                    React.createElement(Button, { bsStyle: 'secondary', type: 'submit', onClick: this.onDownloadSVG },
                        React.createElement("i", { className: 'fa fa-download' }),
                        " SVG"),
                    ' ',
                    React.createElement(Button, { bsStyle: 'secondary', type: 'submit', onClick: this.onToggleCode },
                        React.createElement("i", { className: 'fa fa-code' }),
                        ' ',
                        displayingCode ? 'Hide React' : 'Show React'),
                    ' ',
                    React.createElement(Button, { bsStyle: 'secondary', type: 'submit', onClick: this.onToggleImg },
                        React.createElement("i", { className: 'fa fa-code' }),
                        ' ',
                        displayingImg ? 'Hide <img>' : 'Show <img>'),
                    React.createElement("div", { style: { marginTop: '10px' } },
                        React.createElement("iframe", { src: 'https://platform.twitter.com/widgets/tweet_button.html?' +
                                serializeQuery({
