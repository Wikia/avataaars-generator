...
var ComponentCode = /** @class */ (function (_super) {
    ...
    ComponentCode.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            React.createElement("h3", { style: { color: '#6A39D7' } },
                "React Code",
                ' ',
                React.createElement("a", { href: 'https://github.com/fangpenlin/avataaars', style: { fontSize: '0.8em' }, target: '_blank' },
                    React.createElement("i", { className: 'fa fa-github' }),
                    " Repo")),
            React.createElement("p", null, "To use Avataaars in your React app, you need to install the package first. You can do it by running"),
            React.createElement("pre", null,
                React.createElement("code", null, "yarn add avataaars")),
            React.createElement("p", null, "or"),
            React.createElement("pre", null,
                React.createElement("code", null, "npm install avataaars --save")),
            React.createElement("p", null, "if you are using npm. Once you have avataaars package installed, you can copy and paste following code into your React component"),
            React.createElement("textarea", { readOnly: true, style: { width: '100%', height: '10em' }, value: code, ref: this.onTextAreaRef, onFocus: this.onTextAreaClick })));
    };
