...
var urlPropsQueryConfig = __assign(__assign({}, fromPairs(allOptions.map(function (option) { return [
    option.key,
    {
...
var Main = /** @class */ (function (_super) {
    ...
    Main.prototype.render = function () {
        ...
        return (React.createElement("main", { role: 'main' },
            React.createElement("header", { className: 'header clearfix' },
                React.createElement("h2", { style: { color: '#6A39D7' } },
                    "avataaars generator",
                    React.createElement(Button, { type: 'submit', bsStyle: 'secondary', style: { marginLeft: '1rem' }, onClick: this.onRandom, className: 'pull-right' },
                        React.createElement("i", { className: 'fa fa-random' }),
                        " Random"))),
            React.createElement(Helmet, null,
                React.createElement("meta", { property: 'og:title', content: title }),
                React.createElement("meta", { property: 'og:site_name', content: 'Avataaars Generator' }),
                React.createElement("meta", { property: 'og:url', content: document.location.href }),
                React.createElement("meta", { property: 'og:image', content: imageURL }),
                React.createElement("meta", { property: 'og:description', content: 'Avataaars Generator is a free online tool for generating your own avatar' }),
                React.createElement("meta", { name: 'twitter:card', content: 'photo' }),
                React.createElement("meta", { name: 'twitter:site', content: 'Avataaars Generator' }),
                React.createElement("meta", { name: 'twitter:title', content: title }),
                React.createElement("meta", { name: 'twitter:image', content: imageURL }),
                React.createElement("meta", { name: 'twitter:url', content: document.location.href })),
            React.createElement("div", { style: { textAlign: 'center', marginBottom: '1rem' } },
                React.createElement(Avatar, { ref: this.onAvatarRef, avatarStyle: avatarStyle })),
            React.createElement(AvatarForm, { optionContext: this.optionContext, avatarStyle: avatarStyle, displayingCode: displayComponentCode, displayingImg: displayComponentImg, onDownloadPNG: this.onDownloadPNG, onDownloadSVG: this.onDownloadSVG, onAvatarStyleChange: this.onAvatarStyleChange, onToggleCode: this.onToggleCode, onToggleImg: this.onToggleImg }),
            displayComponentImg ? (React.createElement(ComponentImg, { avatarStyle: avatarStyle })) : null,
            displayComponentCode ? (React.createElement(ComponentCode, { avatarStyle: avatarStyle })) : null,
            React.createElement("canvas", { style: { display: 'none' }, width: '528', height: '560', ref: this.onCanvasRef })));
    };
